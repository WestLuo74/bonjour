  ...
  this._onresponse = function (packet, rinfo) {
    ...
    Object.keys(nameMap).forEach(function (name) {
      ...
      matches.forEach(function (service) {
        let srv = self._serviceMap[service.fqdn]
        if (srv) {
          if (JSON.stringify(service) !== JSON.stringify(srv)) { // if service property changed
            self._removeService(service)
...
Browser.prototype._addService = function (service) {
  ...
  this._serviceMap[service.fqdn] = service
